...
show_Hex_window()
{
	gtk_button_set_label(GTK_BUTTON(button1),"");// 按钮pi显示为空
	gtk_widget_show(button1);
	gtk_button_set_label(GTK_BUTTON(button2),"");
	gtk_widget_show(button2);// 按钮sin显示为空
	
	
	gtk_button_set_label(GTK_BUTTON(button3),"");// 按钮cos显示为空
	gtk_widget_show(button3);
	gtk_button_set_label(GTK_BUTTON(button4),"");
	gtk_widget_show(button4);// 按钮tan显示为空

	gtk_button_set_label(GTK_BUTTON(button6),"");// 按钮Exp显示为空
	...
	gtk_widget_show(button18);// 数字按钮A需要显示
	...
	gtk_widget_show(button23);// 数字按钮B需要显示
	...
	gtk_widget_show(button28);// 数字按钮C需要显示

	
	gtk_button_set_label(GTK_BUTTON(button33),"D");
	gtk_widget_show(button33);// 数字按钮D需要显示
	gtk_button_set_label(GTK_BUTTON(button38),"E");
	gtk_widget_show(button38);// 数字按钮E需要显示


	gtk_button_set_label(GTK_BUTTON(button42),"F");
	gtk_widget_show(button42);	// 数字按钮F需要显示
}
